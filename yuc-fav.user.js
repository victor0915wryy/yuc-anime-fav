...
(function () {
    ...
    const simpleMap = {
        ...
        "谰": "讕", "谱": "譜", "谲": "譎", "谳": "讞", "谴": "譴", "谵": "譫", "谶": "讖", "谷": "穀", "豮": "豮", "贝": "貝",
        ...
        "锗": "鍺", "错": "錯", "锚": "錨", "锛": "錛", "锜": "錡", "锝": "鍀", "锞": "錁", "锟": "錕", "锠": "錩", "锡": "錫",
        ...
        "馔": "饌", "馕": "饢", "马": "馬", "驭": "馭", "驮": "馱", "驯": "馴", "驰": "馳", "驱": "驅", "驲": "驲", "驳": "駁",
        "驴": "驢", "驵": "駔", "驶": "駛", "驷": "駟", "驸": "駙", "驹": "駒", "驺": "騶", "驻": "駐", "驼": "駝", "驽": "駑",
        "驾": "駕", "驿": "驛", "骀": "駘", "骁": "驍", "骂": "罵", "骃": "駰", "骄": "驕", "骅": "驊", "骆": "駱", "骇": "駭",
        "骈": "駢", "骉": "驫", "骊": "驪", "骋": "騁", "验": "驗", "骍": "騂", "骎": "駸", "骏": "駿", "骐": "騏", "骑": "騎",
    ...
    for (let s in simpleMap) {
        const tw = simpleMap[s];
        // 跳过空值
        if (!tw) continue;
        // 如果"繁体值"本身也是简体键，说明这条映射方向有误（应为简→繁，但写反了），跳过
        if (simpleMap[tw] !== undefined) continue;
        traditionalMap[tw] = s;
    }
